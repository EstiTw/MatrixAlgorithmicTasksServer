...
public class TcpServer {
   ...
   application layer believe processes on hosts are connected by a data stream
    ...
    4. chrome needs to send a DNS request (A-Record) to figure out Ynet's IP the address.
    ...
    8. chrome receives IP address associated with Ynet.the
 a    9. chrome again needs services from OS - open TCP socket
        ...
        new Thread(() -> {
            ...
            try {
                /*
                 ...
                 3. listen for incoming connections (a client initiates a TCP the cthe onthe nthe ethe cthe tthe ithe on with  the sa server)a
